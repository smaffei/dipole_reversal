...
INTEGER, PARAMETER :: NTHETA_GRID_CONTOUR_GMT = 100, NPHI_GRID_CONTOUR_GMT = 100  !number of points for contour plots in GMT
INTEGER, PARAMETER :: GMT_THETA = 100, GMT_PHI = 100  !grid spacing for arrows in GMT plots
...
! setup grids
    ...
    OPEN(16, FILE = 'BR_DOT_ES.DAT', STATUS = 'REPLACE', FORM = 'FORMATTED')
    OPEN(17, FILE = 'BR_ES.DAT', STATUS = 'REPLACE', FORM = 'FORMATTED')
