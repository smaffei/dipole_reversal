...
REAL( KIND = 8) ::  B_LOCATION(3), THETA, PHI
...
REAL( KIND = 8) :: COSTHETA_LOC, SINTHETA_LOC, PHI_DEP, DERV_PHI_DEP, B_DOT_LOCATION(3), F_LOC, MAX_INTENSITY_RATE, NORM_FACTOR, KE, TOTAL_RMS, VALUE(1:4), DIPOLE_TILT_RATE, NORM_G
REAL( KIND = EXTRA_LONG_REAL) :: LOCATIONS(1)
REAL( KIND = 8), ALLOCATABLE :: GAUSS(:), SPEC_U_TOR(:), SPEC_U_POL(:), G(:,:)
REAL( KIND = 8), ALLOCATABLE :: B_R_DOT(:,:), EVEC_TOR(:), EVEC_POL(:)
...
REAL( KIND = 8) :: OBS_COLAT, OBS_LONG, PHI_OBS
INTEGER :: RESTRICTION
