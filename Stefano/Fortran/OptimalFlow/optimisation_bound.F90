...
CONTAINS
  ...
  IMPLICIT NONE
    ...
    REAL( KIND = 8), ALLOCATABLE, INTENT(OUT) :: SPEC_U_TOR(:), SPEC_U_POL(:)
    REAL( KIND = 8), ALLOCATABLE, DIMENSION(:), INTENT(OUT) :: GAUSS
    REAL( KIND = 8), INTENT(INOUT) ::OBS_COLAT, OBS_LONG, PHI_OBS
    ...
    REAL( KIND = 8) :: B_LOCATION(3), THETA, PHI, VALUE(2)
    ...
    REAL( KIND = 8) :: COSTHETA_LOC, SINTHETA_LOC, PHI_DEP, DERV_PHI_DEP, B_DOT_LOCATION(3), F_LOC, D_LOC, TILT, MAX_INTENSITY_RATE, DIPOLE_TILT_RATE, NORM_FACTOR, KE, TOTAL_RMS, KE_TOR, KE_POL
    REAL( KIND = EXTRA_LONG_REAL) :: LOCATIONS(1)
    REAL ( KIND = 16 ) :: DIFFUSION, FACTOR, NORM_G, INCLINATION
