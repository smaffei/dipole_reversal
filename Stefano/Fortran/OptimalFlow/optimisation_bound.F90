...
CONTAINS
  ...
  IMPLICIT NONE
    ...
    REAL( KIND = EXTRA_LONG_REAL) :: B_LOCATION(3), THETA, PHI, VALUE(2), X, P, Y
    ...
    REAL( KIND = EXTRA_LONG_REAL) :: COSTHETA_LOC, SINTHETA_LOC, PHI_DEP, DERV_PHI_DEP, B_DOT_LOCATION(3), F_LOC, D_LOC, I_LOC, TILT, MAX_INTENSITY_RATE, DIPOLE_TILT_RATE, NORM_FACTOR, KE, TOTAL_RMS, KE_TOR, KE_POL
