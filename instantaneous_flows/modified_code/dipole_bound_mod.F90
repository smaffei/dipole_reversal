...
INTEGER :: L, M, SINCOS, POLTOR, LMAX_B_OBS, LMAX_U, IOS, LMAX_FILE, NP, i, HARMONIC, LMAX_SV, NTHETA_GRID, NPHI_GRID, I_PHI, I_THETA, NUM_LEGENDRE_SV, INDEX_PLM, J, HARMONIC_TYPE, RESTRICTION, INDEX, SAVE_FLAG
...
! Therefore, since we want B_dot to be computed using a flow given in m/yr (since radius r is measured in metres in the induction equation), multiply by 1000 to convert km -> m.
      ...
      PRINT*, MAX_DIPOLE_GROWTH_RATE, KE_POL, KE_TOR
